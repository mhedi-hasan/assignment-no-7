...
const Footer = () => {
    return (
        <div>
            <footer className="footer mt-16 p-10 bg-gray-200 text-base-content">
...
<footer className="footer lg:px-20 py-10  border-t bg-gray-300 text-base-content border-base-300">
